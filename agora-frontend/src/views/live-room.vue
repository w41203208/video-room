<template>
  <Layout :rtc="rtcClinet">
    <template #main>
      <section
        class="flex flex-col md:flex-row h-screen overflow-hidden relative"
      >
        ...
        >
          <div class="flex-1" id="chat-box"></div>
          <div class="flex flex-col relative" style="min-width: 270px">
            <div id="video-box " class="relative">
              <p
                class="absolute left-1/2 transform -translate-x-1/2 bottom-1 z-10 text-red-400"
              >
                {{ localPlayer }}
              </p>
              <div
                class="w-full h-52 rounded-2xl border-4 border-gray-300 overflow-hidden"
                ref="selfDivRef"
              ></div>
            </div>
          </div>
