...
type CreateToken = (prefix: string) => CreateTokenFunc;
 ...
 * @return {Object}
 */
const formatJSON = (object: any) => {
  const keys = Object.keys(object).sort();
  const target = {} as Record<string | number, any>;
 ...
 */
const createToken: CreateToken = (prefix) => {
